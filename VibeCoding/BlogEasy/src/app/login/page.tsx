      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Bienvenue sur BlogEasy</CardTitle>
            <CardDescription>
              Connectez-vous pour commencer à générer du contenu SEO de qualité
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
            ...
            <div className="mt-6 text-center text-sm text-gray-600">
              ...
              <Link href="/terms" className="text-turquoise hover:underline">
